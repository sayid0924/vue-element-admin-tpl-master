      ...
      <el-col :span="12" :offset="4">
        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
          ...
          <el-form-item class="button_submit">
            <m-button type="info"  @click.prevent="submitForm('formData')">立即创建</m-button>
          </el-form-item>
    ...
    data () {
      return {
        formData: {
          ...
          userId: 1, //      用户ID
          doctorName: 'sayid', //     医生名称
          pcaCode: 1111, //     行政区代码
          address: '深圳', //     地址
          postCode: 2222, //    邮政编码
          mobile: '15115182312', //   手机号码
          intro: '111', //    简介
          specialty: '11', //    特长
          areaCode: '2222', //    区域编码
          education: '222', //    学历
